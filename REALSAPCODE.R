...
# ============================================================
# 5. Train Models with Regularization
# ============================================================
...
# Function 1: Quick single player prediction
...
predict_batch <- function(players_df, use_calibrated = TRUE) {
  # players_df should have columns: player_name, position, and all stat columns
...
cat("EXAMPLE: Quick prediction with all stats (including height)\n")
...
quick_predict_v2('Deandre Ayton',
                 list(
                   ...
                   adjoe    = 133,
                   drtg     = 95,
                   adrtg    = 92,quick_predict_v2('Trae Young',
                 list(
                   height_in = 74,      # 6'2"
                   Ortg      = 112.1,
                   usg       = 38.4,
...
quick_predict_v2('Stephen Curry',
                 list(
                   height_in = 75,      # 6'3"
                   Ortg    = 118,
                   usg     = 37.5,
